...
var randy = (function () {
    ...
    if (typeof module !== "undefined") {
        ...
        var generator = well1024(entropy);
        module.exports = initialize(generator);
    } else {
        // Browser mode
        var entropy = [
    ...
    function initialize (generator) {
        ...
        function wrapWithPrecision (baseRandInt, randMax) {
