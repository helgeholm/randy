...
var randy = (function () {
    function well1024 (entropy) {
        ...
        var int32_to_float = 1.0 / 4294967296;
    ...
    function initialize (getUInt32) {
         ...
         * max is assumed to be 4294967296.  I.e. full range UINT32.
         *
        ...
        function randInt (min, max, step) {
            ...
            var result = min + (getUInt32() % span) * step;
            return result;
        }
        ...
        function random () {
            return getUInt32() / 0x100000000;
        }

        /* Returns a floating point number f such that min <= f < max. */
        function uniform (min, max) {
            return min + (getUInt32() * (max - min)) / 0x100000000;
        }
